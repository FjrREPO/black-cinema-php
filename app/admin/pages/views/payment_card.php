            ...
            <form id="addPaymentCardForm" class="p-4 md:p-5" action="pages/controller/payments/payment_card/add_payment_card.php" method="POST">
                ...
                <div class="flex flex-row w-full gap-3">
                    ...
                    <div class="mb-4 w-1/2">
                        ...
                        <input type="text" id="imageCard" name="imageCard" placeholder="https://" required class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring-gray-500 focus:border-gray-500 dark:bg-gray-800 dark:border-gray-600 dark:focus:ring-gray-500 dark:focus:border-gray-500 dark:text-white">
                    </div>
                </div>
                <div class="mb-4 w-full">
                    <label for="imageQR" class="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-300">Gambar QR</label>
                    <input type="text" id="imageQR" name="imageQR" placeholder="https://" required class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring-gray-500 focus:border-gray-500 dark:bg-gray-800 dark:border-gray-600 dark:focus:ring-gray-500 dark:focus:border-gray-500 dark:text-white">
                </div>
