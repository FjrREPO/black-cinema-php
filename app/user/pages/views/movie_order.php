...
<body class="w-screen min-h-screen bg-cover bg-no-repeat" style="background: url('<?php echo isset($rowMovie['backdrop_path']) ? $rowMovie['backdrop_path'] : ''; ?>')">
    <div class='flex flex-col backdrop-brightness-50 h-[87vh] overflow-y-hidden z-10 flex items-center justify-center'>
                ...
                <form method="post" action="pages/controller/payments/add_payment.php" class="relative flex flex-col mb-5 md:mb-0 bg-clip-border rounded-xl bg-gradient-to-tr from-gray-900 to-gray-800 text-white shadow-gray-900/20 shadow-md w-full max-w-[20rem] p-8">
                    ...
                    <div class="p-0 mt-12">
                        ...
                        <div class="flex flex-col items-center justify-center w-full gap-2">
                            ...
                            <input type="datetime-local" name="startTime" class="px-5 py-2 bg-white text-black border border-gray-600 rounded-lg">
